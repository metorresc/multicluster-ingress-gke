...
--enable-ip-alias \
--network "projects/$SHARED_VPC_PROJECT_ID/global/networks/$VPC_NAME" \
--subnetwork "projects/$SHARED_VPC_PROJECT_ID/regions/$REGION/subnetworks/$SUBNET_NAME" \
...
--master-authorized-networks 10.0.0.0/16,10.100.0.0/16 \
